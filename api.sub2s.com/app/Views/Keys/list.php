            ...
            <div class="card shadow-sm">
                <div class="card-header bg-danger text-white">
                    <div class="row">
                       <div class="col pt-1">
    Keys Registered
    <button class="btn btn-secondary btn-sm ms-1" id="blur-out" data-bs-toggle="tooltip" data-bs-placement="top" title="Eye Visible">
        <i class="bi bi-eye"></i>
    </button>
</div>
                                 ...
                                 <div class="card-header bg-light text-black h6 p-3">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="<?= site_url('keys/deleteExp')  ?>">
                                            <i class="bi bi-eraser"></i> Delete Expired Keys
                                        </a>
                                    </li>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        // Trả về giao diện copy, nếu không có key thì hiện gạch ngang
                        let key = data ? data : row.user_key;
                        return `<span class="copy-link" onclick="copySimple('${key}')">${key}</span>`;
                    }
                },
                {
                    data: 'devices',
