...
class UserModel extends Model
{
    ...
    protected $allowedFields = [
        'username', 'fullname', 'saldo', 'level', 'status', 'uplink', 'password','user_ip',
        'short_api_base', 'short_response_type', 'short_response_key', 'vn_short_config', 
        'global_short_config', 'key_duration', 'discord_link', 'buy_key_link',
         'sepay_api_key', 'partner_key', 'partner_id', 'price_per_api', 'bank_prefix',
         'bank_name' , 'bank_number', 'bank_id', 'short_api_list', 'api_counter', 'quick_banks_json', 'enable_free_global'
    ];
